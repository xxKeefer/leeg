...
4. **Verify** — run `pnpm --filter backend typecheck`, `pnpm --filter frontend typecheck`, and `pnpm --filter backend test` before committing. Fix any failures before proceeding.
